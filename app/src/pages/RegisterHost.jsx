...
const RegisterHost= () => {
    ...
    const [formData, setFormData] = useState({
        ...
        address: '',
        rfc: '',
        role: 'host', // Valor por defecto según el ticket
    ...
    const handleSubmit = async (e) => {
        ...
        const requiredFields = ['firstName', 'lastName', 'email', 'password', 'birthday', 'phone', 'address', 'rfc'];
        ...
        try {
            ...
            if (response.ok) {
                ...
                const errorMessage = data.message || 'Ocurrió un error al registrar el host.';
                setResponseMessage({
            ...
            <div className="row justify-content-center">
                <div className="col-md-8 col-lg-6">
                    <form onSubmit={handleSubmit} className="p-4 border rounded shadow-sm">
                        ...
                        <button type="submit" className="btn btn-primary w-100">Registrar Host</button>
                    </form>
